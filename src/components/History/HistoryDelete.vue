...
import { destroyUserManualHistory } from '@/services/modules/UserManualHistoryService'
import { ref, computed } from 'vue'
import { useRoute } from 'vue-router'

const props = defineProps({
  user_manual_history_id: String
})
...
const handleDelete = async () => {
  try {
    const response = await destroyUserManualHistory(route.params.id, props.user_manual_history_id)
